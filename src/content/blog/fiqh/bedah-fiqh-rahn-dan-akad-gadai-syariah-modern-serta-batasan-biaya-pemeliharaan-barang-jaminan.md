---
title: Bedah Fiqh Rahn dan Akad Gadai Syariah Modern Serta Batasan Biaya Pemeliharaan Barang Jaminan
draft: false
sticky: false
tocNumbering: true
...
tags:
  ...
  - fintech syariah
  - fatwa dsn mui
description: Bedah tuntas fiqh rahn dan gadai syariah modern, batasan biaya ijarah pemeliharaan marhun agar tidak terjerumus ke dalam riba qardh terselubung.
cover: https://img.shlproject.com/2026/09/17758eb6ff647be7ddf08370af19c449.webp
link: fiqh/Bedah-Fiqh-Rahn-dan-Akad-Gadai-Syariah-Modern-Serta-Batasan-Biaya-Pemeliharaan-Barang-Jaminan
---
![BlockNote image](https://img.shlproject.com/2026/09/17758eb6ff647be7ddf08370af19c449.webp)
...
```mermaid
graph TD
    A[Nasabah / Rahin] -->|1. Mengajukan Pinjaman Dana| B[Akad Qardh / Pembiayaan]
    A -->|2. Menyerahkan Jaminan Emas/Aset| C[Akad Rahn / Pengikatan Jaminan]
    A -->|3. Menitipkan & Menyewa Brankas| D[Akad Ijarah / Jasa Simpan & Asuransi]
    B --> E[Lembaga Keuangan Syariah / Murtahin]
    C --> E
    D --> E
```
...
```mermaid
graph TD
    A[Jatuh Tempo Pembayaran] --> B{Nasabah Melunasi?}
    B -->|Ya| C[Barang Jaminan Dikembalikan Penuh]
    B -->|Tidak / Wanprestasi| D[Pemberian Surat Peringatan & Restrukturisasi]
    D --> E{Masih Gagal Bayar?}
    E -->|Ya| F[Penjualan Lelang Terbuka Sesuai Harga Pasar]
    F --> G[Pelunasan Pokok Utang & Biaya Riil Lelang]
    G --> H{Ada Sisa Dana Penjualan?}
    H -->|Ya| I[Sisa Dana Wajib Dikembalikan ke Nasabah]
    H -->|Kurang| J[Kekurangan Tetap Menjadi Utang Nasabah]
```
